databaseChangeLog(logicalFilePath: 'dev-1') {
    changeSet id: '1', author: 'author', {
        ...
        rollback {
            delete tableName: 'user', where: 'id_user in (1,2)'
        }
    }
	
	changeSet id: '2', author: 'author', {
        insert tableName: 'user_corespondence', {
		    column name: 'id_user_corespondence', value: 1
		...
		insert tableName: 'user_corespondence', {
		    column name: 'id_user_corespondence', value: 2
        ...
        rollback {
            delete tableName: 'user_corespondence', where: 'id_user_corespondence in (1,2)'
        }
    }
	
	changeSet id: '3', author: 'author', {
        insert tableName: 'user_photo', {
		    column name: 'id_user_photo', value: 1
		...
		insert tableName: 'user_photo', {
		    column name: 'id_user_photo', value: 2
        ...
        rollback {
            delete tableName: 'user_photo', where: 'id_user_photo in (1,2)'
        }
    }
	
	changeSet id: '4', author: 'author', {
        insert tableName: 'user_security', {
		    column name: 'id_user_security', value: 1
		...
		insert tableName: 'user_security', {
		    column name: 'id_user_security', value: 2
        ...
        rollback {
            delete tableName: 'user_security', where: 'id_user_security in (1,2)'
        }
    }
	
	changeSet id: '5', author: 'author', {
        insert tableName: 'link', {
		    column name: 'id_link', value: 1
        ...
        rollback {
            delete tableName: 'link', where: 'id_link in (1,2)'
        }
    }
	
	changeSet id: '6', author: 'author', {
        insert tableName: 'link_history', {
		    column name: 'id_link_history', value: 1
            column name: 'created_at_timestamp', value: 1468330053
		...
		insert tableName: 'link_history', {
		    column name: 'id_link_history', value: 2
        ...
        rollback {
            delete tableName: 'link', where: 'id_link_history in (1,2)'
        }
    }
}